      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <a href="#home" className="logo text-green-600 font-bold text-xl">
              Store
            </a>
          </div>
          ...
          <div className="-mr-2 flex md:hidden sm:hidden">
            <button onClick={() => setIsOpen(!isOpen)}
              className="bg-green-600 text-white inline-flex items-center justify-center p-2 rounded-md hover:text-white  focus:outline-none focus:bg-green-700 focus:text-white">
